	...
	function addContext(selector, data) {
		...
		$(document).on('contextmenu', selector, function (e) {
			...
			if (typeof options.above == 'boolean' && options.above) {
				...
				// TODO(thomthom): Hacked this from the original source. There is a bug
				// where the menu fails to display if you set above: false. And there is
				// another bug which when above is true or 'auto' will show the menu
